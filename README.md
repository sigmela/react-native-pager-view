...
| `scrollLeftEnabled: boolean`                                         |                                                                                                            Should pager view left scroll, when left scroll enabled                                                                                                            |   both   |
| `scrollRightEnabled: boolean`                                        |                                                                                                            Should pager view right scroll, when right scroll enabled                                                                                                            |   both   |
